...
`);
  ...
  const checks = [
    ...
    [plan.workers.every((worker) => worker.model === 'gpt-6-luna'), 'runner did not use Luna'],
    [plan.workers.every((worker) => worker.reasoningEffort === 'default'), 'runner did not use Luna default effort'],
